...
from ants.utils.template import render_templatefile, string_camelcase
from ants.exceptions import UsageError

TEMPLATES_PATH = join(ants.__path__[0], 'templates', 'project')
...
class Command(ScrapyCommand):
    ...
    def run(self, args, opts):
        ...
        shutil.copy(join(TEMPLATES_PATH, 'ants.cfg'), project_name)
        ...
        print("    ants genspider example example.com")
