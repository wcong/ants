...
from ants.utils.http import basic_auth_header
from ants.utils.python import retry_on_eintr
from ants.utils.conf import get_config, closest_scrapy_cfg

_SETUP_PY_TEMPLATE = \
"""# Automatically created by: ants deploy
...
setup(
    ...
    entry_points = {'ants': ['settings = %(settings)s']},
)
"""
