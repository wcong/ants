...
from ants.core.engine import ExecutionEngine
from ants.resolver import CachingThreadedResolver
from ants.extension import ExtensionManager
from ants.signalmanager import SignalManager
from ants.utils.ossignal import install_shutdown_handlers, signal_names
...
class CrawlerProcess(object):
    """ A class to run multiple ants crawlers in a process sequentially"""
    ...
    # any moment.
    #
    # start_crawling and start_reactor are called from ants.commands.shell
