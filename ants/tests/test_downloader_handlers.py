...
from ants import twisted_version
from ants.core.downloader.handlers import DownloadHandlers
from ants.core.downloader.handlers.file import FileDownloadHandler
from ants.core.downloader.handlers.http import HTTPDownloadHandler, HttpDownloadHandler
from ants.core.downloader.handlers.http10 import HTTP10DownloadHandler
from ants.core.downloader.handlers.http11 import HTTP11DownloadHandler
from ants.core.downloader.handlers.s3 import S3DownloadHandler
from ants.core.downloader.handlers.ftp import FTPDownloadHandler
...
class LoadTestCase(unittest.TestCase):
    ...
    def test_enabled_handler(self):
        handlers = {'scheme': 'ants.tests.test_downloader_handlers.DummyDH'}
        dh = DownloadHandlers(get_crawler({'DOWNLOAD_HANDLERS': handlers}))
        self.assertIn('scheme', dh._handlers)
        self.assertNotIn('scheme', dh._notconfigured)

    def test_not_configured_handler(self):
        handlers = {'scheme': 'ants.tests.test_downloader_handlers.OffDH'}
        dh = DownloadHandlers(get_crawler({'DOWNLOAD_HANDLERS': handlers}))
