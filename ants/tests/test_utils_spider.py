...
from ants.utils.spider import iterate_spider_output, iter_spider_classes

from ants.contrib.spiders import CrawlSpider
...
class UtilsSpidersTestCase(unittest.TestCase):
    ...
    def test_iter_spider_classes(self):
        import ants.tests.test_utils_spider
        it = iter_spider_classes(ants.tests.test_utils_spider)
