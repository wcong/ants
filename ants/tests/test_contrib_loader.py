...
from ants.contrib.loader import ItemLoader
from ants.contrib.loader.processor import Join, Identity, TakeFirst, \
    Compose, MapCompose
...
class BasicItemLoaderTest(unittest.TestCase):
    ...
    def test_map_compose_filter(self):
        ...
        self.assertEqual(proc(['hello', 'world', 'this', 'is', 'ants']),
    ...
    def test_input_processor_inheritance(self):
        ...
        il = ChildItemLoader()
        il.add_value('url', u'HTTP://ants.ORG')
        self.assertEqual(il.get_output_value('url'), [u'http://ants.org'])
        il.add_value('name', u'marta')
        self.assertEqual(il.get_output_value('name'), [u'Marta'])
...
class ProcessorsTest(unittest.TestCase):
    ...
    def test_mapcompose(self):
        ...
        self.assertEqual(proc([u'hello', u'world', u'this', u'is', u'ants']),
...
class SelectortemLoaderTest(unittest.TestCase):
    ...
    <div id="id">marta</div>
    <p>paragraph</p>
    <a href="http://www.ants.org">homepage</a>
    ...
    def test_constructor_with_response_css(self):
        ...
        self.assertEqual(l.get_output_value('url'), [u'http://www.ants.org'])
        ...
        self.assertEqual(l.get_output_value('url'), [u'http://www.ants.org', u'/images/logo.png'])
    ...
    def test_add_css_re(self):
        ...
        self.assertEqual(l.get_output_value('url'), [u'www.ants.org'])
    ...
    def test_get_css(self):
        ...
        self.assertEqual(l.get_css(['a::attr(href)', 'img::attr(src)']),
            [u'http://www.ants.org', u'/images/logo.png'])
    ...
    def test_replace_css_re(self):
        ...
        self.assertEqual(l.get_output_value('url'), [u'ants.org'])
