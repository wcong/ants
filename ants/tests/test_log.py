...
from ants.settings import default_settings
...
class ScrapyFileLogObserverTest(unittest.TestCase):
    ...
    def test_msg_basic(self):
        log.msg("Hello")
        self.assertEqual(self.logged(), "[ants] INFO: Hello")
    ...
    def test_msg_level1(self):
        ...
        self.assertEqual(self.logged(), "[ants] WARNING: Hello")
    ...
    def test_msg_wrong_level(self):
        ...
        self.assertEqual(self.logged(), "[ants] NOLEVEL: Hello")
    ...
    def test_msg_encoding(self):
        ...
        self.assertEqual(self.logged(), "[ants] INFO: Price: \xc2\xa3100")

    def test_msg_ignore_level(self):
        log.msg("Hello", level=log.DEBUG)
        log.msg("World", level=log.INFO)
        self.assertEqual(self.logged(), "[ants] INFO: World")
    ...
    def test_err_why(self):
        ...
        self.assertEqual(self.first_log_line(), "[ants] ERROR: Wrong type")
...
# this test fails in twisted trial observer, not in ants observer
#    def test_err_why_encoding(self):
#        log.err(TypeError("bad type"), u"\xa3")
#        self.assertEqual(self.first_log_line(), "[ants] ERROR: \xc2\xa3")
...
class Latin1ScrapyFileLogObserverTest(ScrapyFileLogObserverTest):
    ...
    def test_msg_encoding(self):
        ...
        self.assertEqual(self.logged(), "[ants] INFO: Price: \xa3100")

# this test fails in twisted trial observer, not in ants observer
#    def test_err_why_encoding(self):
#        log.err(TypeError("bad type"), u"\xa3")
#        self.assertEqual(self.first_log_line(), "[ants] ERROR: \xa3")
