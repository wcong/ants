...
from ants.settings import Settings, SettingsAttribute, CrawlerSettings
...
class SettingsTest(unittest.TestCase):
    ...
    @mock.patch.dict('ants.settings.SETTINGS_PRIORITIES', {'default': 10})
    @mock.patch('ants.settings.default_settings', default_settings)
    ...
    @mock.patch.dict('ants.settings.SETTINGS_PRIORITIES', {})
    @mock.patch('ants.settings.default_settings', {})
    ...
    def test_setmodule_by_path(self):
        ...
        self.settings.setmodule(
            'ants.tests.test_settings.default_settings', 10)
