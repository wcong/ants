...
# ugly hack to avoid cyclic imports of ants.spider when running this test
# alone
from ants.interfaces import ISpiderManager
from ants.spidermanager import SpiderManager
...
class SpiderManagerTest(unittest.TestCase):
    ...
    def test_load_spider_module(self):
        self.spiderman = SpiderManager(['ants.tests.test_spidermanager.test_spiders.spider1'])
        assert len(self.spiderman._spiders) == 1

    def test_load_base_spider(self):
        self.spiderman = SpiderManager(['ants.tests.test_spidermanager.test_spiders.spider0'])
