...
from ants.http import Response, HtmlResponse, Request
...
from ants.contrib.downloadermiddleware.httpcache import HttpCacheMiddleware


class _BaseTest(unittest.TestCase):

    storage_class = 'ants.contrib.httpcache.DbmCacheStorage'
    policy_class = 'ants.contrib.httpcache.RFC2616Policy'
...
class DbmStorageWithCustomDbmModuleTest(DbmStorageTest):
    ...
    dbm_module = 'ants.tests.mocks.dummydbm'
...
class FilesystemStorageTest(DefaultStorageTest):
    ...
    storage_class = 'ants.contrib.httpcache.FilesystemCacheStorage'


class LeveldbStorageTest(DefaultStorageTest):

    pytest.importorskip('leveldb')
    storage_class = 'ants.contrib.httpcache.LeveldbCacheStorage'


class DummyPolicyTest(_BaseTest):

    policy_class = 'ants.contrib.httpcache.DummyPolicy'
