...
from ants.http import Response, TextResponse, XmlResponse, HtmlResponse, Headers
...
class ResponseTypesTest(unittest.TestCase):
    ...
    def test_custom_mime_types_loaded(self):
        # check that mime.types files shipped with ants are loaded
        self.assertEqual(responsetypes.mimetypes.guess_type('x.scrapytest')[0], 'x-ants/test')
