...
from ants.contrib.downloadermiddleware.cookies import CookiesMiddleware
...
class CookiesMiddlewareTest(TestCase):
    ...
    def test_complex_cookies(self):
        ...
        cookies = [{'name': 'C1', 'value': 'value1', 'path': '/foo', 'domain': 'scrapytest.org'},
                ...
                {'name': 'C4', 'value': 'value4', 'path': '/foo', 'domain': 'ants.org'}]
    ...
    def test_cookiejar_key(self):
        ...
        req6 = Request('file:///ants/sometempfile')
