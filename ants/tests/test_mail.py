...
class MailSenderTest(unittest.TestCase):
    ...
    def test_send(self):
        ...
        mailsender.send(to=['test@ants.org'], subject='subject', body='body', _callback=self._catch_mail_sent)

        assert self.catched_msg

        self.assertEqual(self.catched_msg['to'], ['test@ants.org'])
        self.assertEqual(self.catched_msg['subject'], 'subject')
        self.assertEqual(self.catched_msg['body'], 'body')

        msg = self.catched_msg['msg']
        self.assertEqual(msg['to'], 'test@ants.org')
    ...
    def test_send_html(self):
        mailsender = MailSender(debug=True)
        mailsender.send(to=['test@ants.org'], subject='subject', body='<p>body</p>', mimetype='text/html', _callback=self._catch_mail_sent)
    ...
    def test_send_attach(self):
        ...
        mailsender = MailSender(debug=True)
        mailsender.send(to=['test@ants.org'], subject='subject', body='body',
