...
from ants.xlib.pydispatch import dispatcher
from ants.tests import tests_datadir
...
from ants.utils.signal import disconnect_all
...
class EngineTest(unittest.TestCase):
    ...
    def _assert_signals_catched(self):
        ...
        self.run.signals_catched[signals.spider_closed].pop('spider_stats', None) # XXX: remove for ants 0.17
