...
from ants.http import TextResponse, HtmlResponse, XmlResponse
from ants.selector import Selector
from ants.selector.lxmlsel import XmlXPathSelector, HtmlXPathSelector, XPathSelector
...
class SelectorTestCase(unittest.TestCase):
    ...
    def test_namespaces_simple(self):
        body = """
        <test xmlns:somens="http://ants.org">
        ...
        x.register_namespace("somens", "http://ants.org")
...
<BrowseNode xmlns="http://webservices.amazon.com/AWSECommerceService/2005-10-05"
            ...
            xmlns:p="http://www.ants.org/product" >
    ...
    <p:SecondTestTag><material>iron</material><price>90</price><p:name>Dried Rose</p:name></p:SecondTestTag>
        ...
        x.register_namespace("p", "http://www.ants.org/product")
...
class DeprecatedXpathSelectorTest(unittest.TestCase):
    ...
    def test_warnings_xpathselector(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertIn('ants.Selector', str(w[0].message))
            ...
            self.assertIn('ants.Selector', str(w[1].message))
