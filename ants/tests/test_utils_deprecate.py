...
class WarnWhenSubclassedTest(unittest.TestCase):
    ...
    def test_subclassing_warning_message(self):
        ...
        self.assertEqual(
            str(w[0].message),
            "ants.tests.test_utils_deprecate.UserClass inherits from "
            "deprecated class ants.tests.test_utils_deprecate.Deprecated, "
            "please inherit from ants.tests.test_utils_deprecate.NewName."
    ...
    def test_warning_on_instance(self):
        ...
        self.assertEqual(
            str(w[0].message),
            "ants.tests.test_utils_deprecate.Deprecated is deprecated, "
            "instantiate ants.tests.test_utils_deprecate.NewName instead."
        )
    ...
    def test_warning_auto_message(self):
        ...
        msg = str(w[0].message)
        self.assertIn("ants.tests.test_utils_deprecate.NewName", msg)
        self.assertIn("ants.tests.test_utils_deprecate.Deprecated", msg)
